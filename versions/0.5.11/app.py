...
class App(tk.Tk):
    ...
    def show_users(self):
        ...
        if self.current_user['role'] == 'OWNER':
            tk.Button(footer, text='Alterar perfil', command=lambda: self.change_user_role_dialog(tree),
    ...
    def change_user_role_dialog(self, tree):
        ...
        tk.Button(form, text='Salvar perfil', command=save, bg=NAVY, fg='white', bd=0, pady=10,
