...
class App(ModernMixin, tk.Tk):
    ...
    def show_login(self):
        ...
        tk.Checkbutton(panel, text='Mostrar senha', variable=show_password,
                       ...
                       bg='#073DA8', fg=WHITE, activebackground='#073DA8',
                       selectcolor='#073DA8', font=('Segoe UI', 9), bd=0).pack(anchor='w', pady=(10, 0))
        status = tk.Label(panel, text='', bg='#073DA8', fg='#FFE5E5',
        ...
        self._pill_button(panel, 'Entrar no sistema', login)
        Button(panel, text='Esqueci minha senha', bg='#073DA8', fg=WHITE,
               command=lambda: messagebox.showinfo('Recuperação de senha',
                   ...
                   parent=self)).pack(fill='x',pady=(7,0))
